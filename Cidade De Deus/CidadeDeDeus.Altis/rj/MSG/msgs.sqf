...
[] spawn {  
    ...
    while {true} do {  
        ...
        hint parseText format["<t color='#ffffff' size='2'>Cidade De Deus</t><t color='#c45454' size='2'>AL</t><br/><br/><img shadown='false' size='6' image='textures\bannerP.jpg'/><br/><br/>%1", _message];  
        sleep _refreshTime;  
        if (_i == (_count - 1)) then {  
            _i = 0;  
        } else {  
