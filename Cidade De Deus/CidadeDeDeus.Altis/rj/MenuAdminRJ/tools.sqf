...
if ((getPlayerUID player) in ["76561198134612622", "", ""]) then { //Lista De Admins
	if ((getPlayerUID player) in ["76561198134612622", "", ""]) then { //Colocar Aqui Tambem A Lista De Admins
		adminmenu =
		[
			["RoberioJr Menu",true],
