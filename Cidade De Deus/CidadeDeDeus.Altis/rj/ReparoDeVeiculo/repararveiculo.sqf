...
#define DEFAULT_FIELDREPAIR_EACH_PART_TIME 60
#define DEFAULT_FIELDREPAIR_EACH_HARDPART_TIME 90
#define DEFAULT_FULLREPAIR_LENGTH 240
#define DEFAULT_REPAIR_TRUCK_USES 3
#define DEFAULT_FREE_REPAIRS 2

#define STR_FIELD_REPAIR "Reparar Veiculo"
#define STR_CANCEL_ACTION "Cancelar Reparo"
#define STR_SERIOUS_REPAIR "Reparar Tudo"
#define STR_REPAIR_CONDITIONS "Sem Condições De Reparo"
#define STR_ANOTHER_ACTION "Você Já Está Fazendo Algo..."
#define STR_NEED_TOOLKIT "Você Precisa De Um Kit De Reparo."
#define STR_REPAIR_INTERRUPTED "Reparo Interrompido"
#define STR_REPAIR_FINISHED "Reparo Completo"
#define STR_REPAIR_MSG_STRING "%2 Vai Demorar %1 Segundos Para Reparar"
#define STR_REPAIR_TRUCK_DEPLETED "Spare parts depleted in repair truck"
#define STR_HELP "Realistic field repair (Edit: RoberioJr) <br/>Script gives each player ability to repair vehicles. <br/>- Repair lasts for 40-400 sec. (Longer for heavy damaged vehicles), it can be interrupted and the continued, time saves.<br/>- Each vehicle could be repaired 1 time for spare parts stored in the vehicle itself.For the next repairs you should have Toolkit in your backpack or in vehicle cargo.<br/>- Field repair fixes only some parts of the vehicle and only to 'Yellow state'.<br/>- Repair from repair trucks lasts 3 min. but completely repairs vehicles. Repair truck can be used 5 times, then spare parts in it will be depleted.<br/>- To use repair truck you should sat on the drivers place of the repair truck then look on damaged vehicle and select 'Full repair' in menu.<br/>"
#define STR_SCRIPTS_NAME "Scripts"
#define STR_SCRIPT_NAME "Reparar Veiculo"
#define STR_PUSH_APC "Empurrar Veiculo"
