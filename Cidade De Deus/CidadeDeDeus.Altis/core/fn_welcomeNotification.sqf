...
_message = "";
_message = _message + "<t align='center' size='6' shadow='0'>Cidade De Deus</t><br /><br />";
...
_message = _message + "Thanks for joining and enjoy your stay, <a color='#B000FF'>Cidade De Deus</a>AltisLife.<br />";
