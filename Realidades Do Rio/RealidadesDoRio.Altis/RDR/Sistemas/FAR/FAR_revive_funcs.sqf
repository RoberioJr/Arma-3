...
FAR_Player_Actions =
{
	if (alive player && player isKindOf "Man") then
	{
		...
		player addAction ["<t color=""#C90000"">" + "Reviver" + "</t>", "RDR\Sistemas\FAR\FAR_handleAction.sqf", ["action_revive"], 10, true, true, "", "call FAR_Check_Revive"];
		player addAction ["<t color=""#C90000"">" + "Estabilizar" + "</t>", "RDR\Sistemas\FAR\FAR_handleAction.sqf", ["action_stabilize"], 10, true, true, "", "call FAR_Check_Stabilize"];
		player addAction ["<t color=""#C90000"">" + "Suicidio" + "</t>", "RDR\Sistemas\FAR\FAR_handleAction.sqf", ["action_suicide"], 9, false, true, "", "call FAR_Check_Suicide"];
		player addAction ["<t color=""#C90000"">" + "Puxar" + "</t>", "RDR\Sistemas\FAR\FAR_handleAction.sqf", ["action_drag"], 9, false, true, "", "call FAR_Check_Dragging"];
	};
};
