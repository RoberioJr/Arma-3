_pathtotools = "RDR\Sistemas\Admin\tools\";
_pathtoweapon = "RDR\Sistemas\Admin\armas\";
_pathtovehicles = "RDR\Sistemas\Admin\veh\";
//_pathtosoldier= "RDR\Sistemas\Admin\spawn\";
