...
If (_Raio < 0) ExitWith { Diag_Log "Erro Ao Configurar Uma Área, Raio Menor Que 0!"; };
...
SERVER SetVariable [_VarMarcador,"NULO"];
...
While {true} Do {
	...
	If (_PntsBOPE IsEqualTo _MaxPontos) Then { _Marcador setMarkerColor "colorblue"; SERVER SetVariable [_VarMarcador,"BOPE"]; [_VarMarcador,_Ganho,_Delay] Spawn RDR_fnc_RecompensaAreas; };
	If (_PntsCV IsEqualTo _MaxPontos) Then { _Marcador setMarkerColor "colorred"; SERVER SetVariable [_VarMarcador,"CV"]; [_VarMarcador,_Ganho,_Delay] Spawn RDR_fnc_RecompensaAreas; };
	If (_PntsPCC IsEqualTo _MaxPontos) Then { _Marcador setMarkerColor "colorgreen"; SERVER SetVariable [_VarMarcador,"PCC"]; [_VarMarcador,_Ganho,_Delay] Spawn RDR_fnc_RecompensaAreas; };
	If (_PntsCIV IsEqualTo _MaxPontos) Then { _Marcador setMarkerColor "colorcivilian"; SERVER SetVariable [_VarMarcador,"CIV"]; [_VarMarcador,_Ganho,_Delay] Spawn RDR_fnc_RecompensaAreas; };
