...
STR_R3F_LOG_action_heliport_larguer = "Largar O Objeto";
STR_R3F_LOG_action_heliport_larguer_fait = "Object ""%1"" dropped.";
STR_R3F_LOG_action_heliport_attente = "Guinchando... (%1)";
...
STR_R3F_LOG_action_aligner_pente = "Ajustar Na Inclinação";
STR_R3F_LOG_action_aligner_sol = "Ajustar Ao Solo";
STR_R3F_LOG_action_aligner_horizon = "Ajustar Na Horizontal";
STR_R3F_LOG_action_tourner = "Girar esquerda/direita (X / C)";
STR_R3F_LOG_action_rapprocher = "Perto/Longe (F / R)";
STR_R3F_LOG_ne_pas_monter_dans_vehicule = "Você não pode entrar no veículo enquanto você está carregando esse objeto!";

STR_R3F_LOG_action_charger_deplace = "Carregar No Veiculo";
STR_R3F_LOG_action_selectionner_objet_charge = "Carrregar ""%1"" in...";
STR_R3F_LOG_action_charger_selection = "... Carregar Em ""%1""";
...
STR_R3F_LOG_action_detacher_impossible_pour_ce_vehicule = "Somente o piloto pode destacar este objeto.";

STR_R3F_LOG_action_contenu_vehicule = "Ver Carga Do Veiculo";
STR_R3F_LOG_action_decharger_en_cours = "Descarregando Veiculo...";
...
STR_R3F_LOG_dlg_CV_titre = "Carga Do Veiculo :";
STR_R3F_LOG_dlg_CV_capacite_vehicule = "Carga : %1/%2";
...
STR_R3F_LOG_nom_fonctionnalite_actif_remorque = "Guinchar";
STR_R3F_LOG_nom_fonctionnalite_actif_transporte = "Transportar";
STR_R3F_LOG_nom_fonctionnalite_actif_transporte_capacite = "Carga Maxima %1";

STR_R3F_LOG_deverrouillage_en_cours = "Destravando... (%1)";
STR_R3F_LOG_deverrouillage_echec_attente = "Desbloqueação cancelada! Mantenha a mira no objeto durante a contagem regressiva.";
STR_R3F_LOG_deverrouillage_succes_attente = "Objeto Destravado.";
STR_R3F_LOG_action_deverrouiller = "Destravar ""%1""";
STR_R3F_LOG_action_deverrouiller_impossible = "Objeto Travado";