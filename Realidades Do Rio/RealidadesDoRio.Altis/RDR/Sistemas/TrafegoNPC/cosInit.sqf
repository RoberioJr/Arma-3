...
// Create a trigger over town	
		...
		_trigAct=format ["null= [%1] execVM ""RDR\Sistemas\TrafegoNPC\cosCore.sqf"";server setvariable [%2,true];",str _foo,str _var];
...
null=[] execVM "RDR\Sistemas\TrafegoNPC\localScript.sqf";// This shows messages for players during multiplayer
