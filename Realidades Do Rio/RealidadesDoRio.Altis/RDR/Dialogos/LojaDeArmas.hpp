...
class RDR_LojaDeArmas
{
	idd = 5000;
	name = "RDR_LojaDeArmas";
	movingEnable = true;
	enableSimulation = 1;
	...
	class Controls
	{
		class ListBoxRDR
		{
			...
			onLBSelChanged = "_this call RDR_fnc_MudancaNoLBArmas";
			class ListScrollBar
			{
				color[] = {1,1,1,1};
