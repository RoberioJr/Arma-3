...
class HG_bandido // HG_DefaultShop is just a placeholder for testing purposes, you can delete it completely and make your own
{
	...
	class Magazines
	{
		...
		items[] =
		{
            {"16Rnd_9x21_Mag",25,"true"},
			{"30Rnd_762x39_Mag_Tracer_Green_F",150,"true"},
			{"30Rnd_545x39_Mag_Tracer_Green_F",75,"true"},
			{"hlc_30Rnd_545x39_t_ak",85,"true"},
			{"hlc_20Rnd_762x51_T_fal",100,"true"},
			{"30Rnd_9x21_Yellow_Mag",45,"true"},
			{"CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M",200,"true"},
			{"CUP_45Rnd_TE4_LRT4_Green_Tracer_545x39_RPK_M",150,"true"},
			{"CUP_20Rnd_TE1_Red_Tracer_762x51_CZ805B",100,"true"},
			{"CUP_30Rnd_Sa58_M_TracerR",90,"true"},
			{"CUP_64Rnd_Red_Tracer_9x19_Bizon_M",80,"true"},
			{"CUP_20Rnd_762x51_L129_M",100,"true"},
			{"CUP_20Rnd_762x51_FNFAL_M",100,"true"},
			{"30Rnd_556x45_Stanag_Tracer_Red",50,"true"},
			{"hlc_45Rnd_762x39_t_rpk",150,"true"},
			{"hlc_50rnd_762x51_MDIM_FAL",175,"true"},
			{"hlc_20Rnd_762x51_T_amt",100,"true"},
			{"hlc_30Rnd_10mm_JHP_MP5",90,"true"},
			{"hlc_30Rnd_9x19_SD_MP5",90,"true"},
			{"hlc_25Rnd_9x19mm_JHP_AUG",120,"true"},
			{"150Rnd_556x45_Drum_Mag_Tracer_F",225,"true"},
	...
	class Scopes
	{
		...
		items[] =
		{
		    {"optic_Arco",300,"true"},
			{"optic_Hamr",350,"true"},
			{"optic_Holosight_blk_F",150,"true"}
			{"cup_optic_mrad",300,"true"},
			{"fhq_optic_ac11704",500,"true"},
			{"fhq_optic_hws",600,"true"},
			{"cup_acc_flashlight",30,"true"},
			{"acc_flashlight",25,"true"},
			{"hlc_acc_surefiregrip",250,"true"},
			{"fhq_accllm01f",225,"true"}
		};
	};
};
