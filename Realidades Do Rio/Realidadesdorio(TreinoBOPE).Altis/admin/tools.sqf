...
if ((getPlayerUID player) in ["76561198134612622", "76561198343381444", "76561198090180406", "76561198308659047"]) then { //all admins
	if ((getPlayerUID player) in ["76561198134612622", "76561198343381444", "76561198090180406", "76561198308659047"]) then { //Admins Go Here aswell
		adminmenu =
		[
			["RoberioJr Menu",true],
