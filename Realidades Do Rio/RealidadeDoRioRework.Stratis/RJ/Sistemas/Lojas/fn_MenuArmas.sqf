...
_InfA = _menu displayCtrl 5010;
 ...
 _CmpP buttonSetAction "[1] call RJ_fnc_ComprarArma;";
 _CmpS buttonSetAction "[2] call RJ_fnc_ComprarArma;";
 _CmpA buttonSetAction "[3] call RJ_fnc_ComprarArma;";
 _VndP buttonSetAction "[] call RJ_fnc_VenderArma;";
 _GrnP ctrlSetText Format["R$%1",RJ_Grana];
