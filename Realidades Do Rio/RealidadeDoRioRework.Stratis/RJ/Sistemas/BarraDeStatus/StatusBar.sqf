...
_rscLayer = "rj_statusbar" call BIS_fnc_rscLayer;
_rscLayer cutRsc["rj_statusbar","PLAIN"];
[] spawn {
uiSleep 2;
 while {true} do {
 uiSleep 1;
 if(isNull ((uiNamespace getVariable "rj_statusbar")displayCtrl 10713)) then {
...
((uiNamespace getVariable "rj_statusbar")displayCtrl 10713)ctrlSetStructuredText parseText
