...
if (isNil "NreEarplugsActive") then {
	NreEarplugsActive = 0;
	1 fadeSound 1;
	_id = player addAction [("<t color=""#00FF00"">" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"tampoes.sqf","",5,false,true,"",""];
	...
	player addEventHandler ["Respawn", {
		...
		_id = (_this select 0) addAction [("<t color=""#00FF00"">" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"tampoes.sqf","",5,false,true,"",""];
...
if ( NreEarplugsActive == 1 ) then {
	...
	_id = player getVariable "NreEarplugsAction";
	player removeAction _id;
	_id = player addAction [("<t color=""#FF0000"">" + (localize "STR_NREEP_OUT_ACTION") +"</t>"),NreEarplugsPath+"tampoes.sqf","",5,false,true,"",""];
	player setVariable ["NreEarplugsAction", _id];
};
