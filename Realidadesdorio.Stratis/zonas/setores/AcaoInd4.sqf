...
"player distance ZonaInd4 < 5", //Condição usada para ser aparecido
"player distance ZonaInd4 < 5", //Condição usada para ser aparecido no progresso
{},
{},
{ZonaInd4 setFlagSide _playerSide;},
