...
"player distance ZonaInd2 < 5", //Condição usada para ser aparecido
"player distance ZonaInd2 < 5", //Condição usada para ser aparecido no progresso
{},
{},
{ZonaInd2 setFlagSide _playerSide;},
