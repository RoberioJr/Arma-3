...
"player distance ZonaInd3 < 5", //Condição usada para ser aparecido
"player distance ZonaInd3 < 5", //Condição usada para ser aparecido no progresso
{},
{},
{ZonaInd3 setFlagSide _playerSide;},
